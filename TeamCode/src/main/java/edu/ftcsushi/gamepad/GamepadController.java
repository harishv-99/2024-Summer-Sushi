...
import edu.ftcsushi.util.PeriodicRunnable;
...
public class GamepadController {
    ...
    private final HashMap<String, InputButton> lookupButton;
    private final HashMap<String, InputInterval> lookupInterval;

    public GamepadController(Gamepad gamepad) {
        this.gamepad = gamepad;

        lookupButton = new HashMap<>();
        lookupInterval = new HashMap<>();
    }
    ...
    public InputButton createButton(String id, GamepadKeys.Button button) {
        ...
        lookupButton.put(id, inputButton);

        // Register this button to be updated every loop so button states can be updated.
        PeriodicRunner.getInstance().addPeriodicRunnable(inputButton);
    ...
    public InputInterval createIntervalUnit(String id, GamepadKeys.Button button) {
        ...
        lookupInterval.put(id, inputInterval);
     ...
     *
     * @param id The string ID of the button to look for
     * @return The {@link InputButton} found
     */
    public InputButton getButton(String id) {
        return lookupButton.get(id);
    }
     ...
     * @return The {@link InputButton} found
     */
    public InputInterval getInterval(String id) {
        return lookupInterval.get(id);
    }
